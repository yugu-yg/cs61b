...
public class BuggyIntDListTest {
    ...
    public void testMergeIntDList() {
        ...
        l.mergeIntDList(m);
        assertEquals("Size after merge should be 13", 6, l.size());
        assertEquals(".getFront() should be 1", 1, l.getFront());
    ...
    public void testReverse() {
        ...
        assertNull(".getFront() after reversal should be null", l._front);
        assertNull(".getBack() after reversal should be null", l._back);
    ...
    public static void main(String[] args) {
        System.exit(ucb.junit.textui.runClasses(BuggyIntDListTest.class));
    }
}
